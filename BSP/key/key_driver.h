...
#define ADKEY_VAL1		0			//按键AD_K1
#define ADKEY_VAL2		491			//按键AD_K2	
#define ADKEY_VAL3		966			//按键AD_K3
#define ADKEY_VAL4		1280		//按键AD_K4	
#define	ADKEY_VAL5		1660		//按键AD_K5	
#define ADKEY_MAX		1800		//ad_key最大电压
#define ADKEY_MIN		0			//ad_key最小电压

/*根据推算测得的电压在对应的区间之内，就是某个按键按下*/
